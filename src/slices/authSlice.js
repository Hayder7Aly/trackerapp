...
import { pushErrorNotification, pushSuccessNotification } from "../utils/pushNotification";

export const SignupUser = createAsyncThunk("todoTracker/auth/signup", async (data, { rejectWithValue }) => {
    try {
...
export const LoginUser = createAsyncThunk("todoTracker/auth/login", async (data, { rejectWithValue }) => {
    try {
